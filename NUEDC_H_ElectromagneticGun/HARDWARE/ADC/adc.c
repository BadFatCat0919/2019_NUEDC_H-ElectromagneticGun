...
{ 	
  ...
  ADC_StructInit(&ADC_InitStructure);
	...
	ADC_RegularChannelConfig(ADC1,ADC_Channel_4,	1,	ADC_SampleTime_239Cycles5);	//PA4
	ADC_RegularChannelConfig(ADC1,ADC_Channel_5,	2,	ADC_SampleTime_239Cycles5);	//PA5
	...
	ADC_RegularChannelConfig(ADC1,ADC_Channel_14,	7,	ADC_SampleTime_239Cycles5);	//PC4
	ADC_RegularChannelConfig(ADC1,ADC_Channel_15,	8,	ADC_SampleTime_239Cycles5);	//PC5
